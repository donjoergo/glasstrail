...
- Friend profile preview image URLs now stay HTTPS for web avatars.
- Friend profile app avatars now normalize Supabase function image paths.
- Prompt before unfriending a friend.
