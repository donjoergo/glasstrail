...
values
  ...
  ('beer-non-alcoholic', 'beer', 'Non-alcoholic Beer', 'Alkoholfreies Bier', 500),
  ...
  ('nonAlcoholic-mate-tea', 'nonAlcoholic', 'Mate Tea', 'Mate Tee', 300),
  ('nonAlcoholic-club-mate', 'nonAlcoholic', 'Club-Mate', 'Club-Mate', 500),
